            ...
            <div className="about-content">
              <div className="about-text">
                <p>
                  ...
                  with a strong foundation in web technologies. Currently pursuing
                  my Master's in Computer Science at Indiana University
                  Bloomington, I bring together technical expertise and creative
                  design thinking to build exceptional digital experiences.
                </p>
                <p>
            ...
            <div className="projects-grid">
              {[
                ...
                },
                {
                  title: "Pet App",
                  description:
                    "Pet care and adoption platform with vet consultation features",
                  image:
